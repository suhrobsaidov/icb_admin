    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/save-depositCards" method="POST">
                    {{ csrf_field() }}
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"> Deposit cards
                        ...
                        <table class="table">
                            ...
                            @foreach($depositCards as $card)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{asset('images/depositCards/'.$card->image)}}" width="70px" height="70px" alt="Image">
                                    </td>
                                    <td>
                                        {{ $card->link }}
                                    </td>
                                    ...
                                    <td>
                                        <a href="/edit-depositCards/{{ $card->id }}" class="btn btn-success">EDIT</a>
                                    </td>
                                    <td>
                                        <form action="/delete-depositCards/{{ $card->id }}" method="post">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
