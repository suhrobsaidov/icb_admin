...
<body>
	<div class="container">
		...
		<div class="bank-cards">
			<div class="bank-cards-input">
				<form action="">
					<img src="./images/icons/searh.png" alt="searh.png" class="searh">
					<input type="search" placeholder="Bank cards">
				</form>
				<p>Found 15 answers</p>
			</div>

			<div class="bank-cards-info">
				<div>
					<h2>Bank cards</h2>
					<p>Due to the spread of a new global pandemic of coronavirus infection (COVID-19), we have extended the expiration date of bank cards to 6 months</p>
					<a href="">https://fmfb.tj/en/cards/</a>
				</div>
				<div>
					<h2>Bank cards</h2>
					<p>Due to the spread of a new global pandemic of coronavirus infection (COVID-19), we have extended the expiration date of bank cards to 6 months</p>
