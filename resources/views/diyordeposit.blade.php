...
<head>
    ...
    <title>‘Diyor’ Deposit</title>
    <link rel="stylesheet" href="./styles/diyor/style.css">
    <link rel="stylesheet" href="./styles/diyor/tablet/style-tablet.css">
    <link rel="stylesheet" href="./styles/diyor/mobile/style-mobile.css">
...
<div class="container">
    ...
    <div class="main">
        ...
        <img src="./images/desktop/diyor-deposit.png" alt="" class="main-image">
    </div>
