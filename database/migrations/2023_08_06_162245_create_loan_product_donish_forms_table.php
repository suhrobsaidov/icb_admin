...
class CreateLoanProductDonishFormsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('loan_product_donish_forms', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('loan_product_donish_forms');
    }
}
