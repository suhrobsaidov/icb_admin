...
class CreateExpressCreditFormsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('express_credit_forms', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('express_credit_forms');
    }
}
