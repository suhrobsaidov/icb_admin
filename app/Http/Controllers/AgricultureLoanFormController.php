...
use App\Models\AgricultureLoanForm;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\File;

class AgricultureLoanFormController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasfile('photo'))
        {
            ...
            $file->move('images/AgricultureLoan/', $filename);
            $form->photo = $filename;
        }
     ...
     *
     * @param  \App\Models\AgricultureLoanForm  $agricultureLoanForm
     * @return \Illuminate\Http\Response
     */
    public function show(AgricultureLoanForm $agricultureLoanForm)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(AgricultureLoanForm $agricultureLoanForm)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, AgricultureLoanForm $agricultureLoanForm, $id)
    {
        $form = AgricultureLoanForm::findOrFail($id);
        $form->surname = $request->input('surname');
        $form->name = $request->input('name');
        $form->middle_name = $request->input('middle_name');
        $form->e_mail = $request->input('e_mail');
        ...
        $form->phone_number_for = $request->input('phone_number_for');
        if ($request->hasfile('photo')) {
            $destination = 'images/AgricultureLoan/' . $form->photo;
        ...
        if ($request->hasfile('passport')) {
            $destination = 'images/AgricultureLoan/' . $form->passport;
            if (File::exists($destination)) {
                File::delete($destination);
            }
            $file = $request->file('passport');
        ...
        if ($request->hasfile('other_documents')) {
            $destination = 'images/AgricultureLoan/' . $form->other_documents;
            if (File::exists($destination)) {
                File::delete($destination);
            }
            $file = $request->file('other_documents');
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(AgricultureLoanForm $agricultureLoanForm, $id)
    {
        $form = AgricultureLoanForm::find($id);
        $destination = 'images/AgricultureLoan/'.$form->photo;
        if (File::exists($destination)){
            File::delete($destination);
        }
