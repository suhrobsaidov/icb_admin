...
Route::apiResource('depositcards', 'API\DepositCardsController');
Route::apiResource('bankloans', 'API\BankLoansController');
Route::apiResource('bankcards', 'API\BankCardsController');
